...
function prebuildify (opts, cb) {
  opts = Object.assign({
    ...
    tagUv: process.env.PREBUILD_TAG_UV === 'true' ? true : process.env.PREBUILD_TAG_UV,
    tagArmv: process.env.PREBUILD_TAG_ARMV === 'true' ? true : process.env.PREBUILD_TAG_ARMV,
    tagLibc: process.env.PREBUILD_TAG_LIBC === 'true' ? true : process.env.PREBUILD_TAG_LIBC,
    cwd: '.',
    targets: []
  }, opts)
